...
The platform currently ingests 360 confidently-detected gravitational wave events from GWTC-1 through the current GWOSC catalog, as of 23 July 2026, of 388 total ingested including marginal and preliminary candidates (see GET /api/gw/stats), 536 Fast Radio Burst detections from CHIME/FRB Catalog 1 (474 one-off events and 62 bursts from 18 repeating sources; CHIME/FRB Collaboration 2021, ApJS 257, 59), and grows its optical transient database daily from TNS and ALeRCE. Seven observatory presets are built in, covering facilities in India, Canada, Hawaii, Chile, the Canary Islands, and California, with support for custom coordinates.
